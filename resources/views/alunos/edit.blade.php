    ...
    <form action="/alunos/update/{{ $aluno->id }}" method="POST"> 
     ...
     @method('PUT')
        ...
        <div class="form-group"> 
            ...
            <input type="text" class="form-control" id="title" name="CPF" placeholder="CPF do aluno" value="{{ $aluno->CPF }}">
        </div> 
        <div class="form-group"> 
            <label for="title">Endereço: </label>
            <input type="text" class="form-control" id="title" name="Endereco" placeholder="Endereço do aluno" value="{{ $aluno->Endereco }}">
        </div> 
         <div class="form-group"> 
