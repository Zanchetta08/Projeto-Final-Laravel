...
<div class="col-md-10 offset-md-1">
    <div class="row">
        ...
        <div id="info-container" class="col-md-6">
            <h1><ion-icon name="school-outline"></ion-icon>Nome do aluno: </h1>
            <p>{{ $aluno->title }}</p>
            <h1><ion-icon name="school-outline"></ion-icon>CPF: </h1>
            <p>{{ $aluno->CPF }}</p>
            <h1><ion-icon name="school-outline"></ion-icon>Endereço: </h1>
            <p>{{ $aluno->Endereco }}</p>
