    ...
    <div id="alunos-create-container" class="col-md-6 offset-md-3">
        ...
        @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="CPF" placeholder="CPF do aluno">
            </div>
            <div class="form-group">
                <label for="title">Endereço: </label>
                <input type="text" class="form-control" id="title" name="Endereco" placeholder="Endereço do aluno">
            </div>
            <div class="form-group">
